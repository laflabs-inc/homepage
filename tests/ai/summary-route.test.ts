...
describe("admin document summary route", () => {
  ...
  it.each([
    ...
    [new SummaryGenerationError("configuration_unavailable"), 409, "configuration_unavailable"],
    ...
    [new AiQuotaError("disabled", "raw settings details"), 409, "disabled"],
    [new AiQuotaError("misconfigured", "raw pricing details"), 409, "misconfigured"],
