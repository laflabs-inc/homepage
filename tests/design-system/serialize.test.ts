...
describe("design-system serializers", () => {
  it("serializes a provider-neutral guide from the current catalog", () => {
    ...
    expect(guide).toContain("System version: 2026.9.6")
  ...
  it("serializes stable, versioned JSON with tokens sorted by id", () => {
    ...
    expect(document.version).toBe("2026.9.6")
  ...
  it("serializes one JSON context with the guide, tokens, and complete Skill", () => {
    ...
    expect(context.version).toBe("2026.9.6")
  ...
  it("serializes the generated repository guide with public machine resources", () => {
    ...
    expect(source).toContain("System version: 2026.9.6")
