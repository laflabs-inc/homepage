...
| Media platform foundation | Next | Establish Vercel Blob storage, protected upload APIs, and Admin asset metadata. |
...
| 4 | Media platform foundation | Next | Vercel Blob storage, Neon metadata, protected upload APIs, validation, and Admin asset library | L | Admin auth and audit log |
