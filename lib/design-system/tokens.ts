...
const typographySpecimens = {
  ...
  methodMark: { fontFamily: "sans", fontSize: "clamp(88px, 10.5vw, 154px)", fontWeight: 850, lineHeight: 0.75, letterSpacing: "-0.04em" },
  heroFieldMark: { fontFamily: "sans", fontSize: "clamp(116px, 14vw, 210px)", fontWeight: 850, lineHeight: 0.75, letterSpacing: "-0.04em" },
...
export const designTokens = [
  ...
  },
  {
    ...
    value: "#0ea5e9",
    cssVariable: "--info",
    purpose: { ko: "정보 상태에만 씁니다.", en: "Reserved for informational status." },
  },
  {
    id: "color.success",
    group: "color",
    value: "#10b981",
    cssVariable: "--success",
    purpose: { ko: "완료와 성공 상태에만 씁니다.", en: "Reserved for successful status." },
  },
  {
    id: "color.warning",
    group: "color",
    value: "#f59e0b",
    cssVariable: "--warning",
    purpose: { ko: "주의가 필요한 상태에만 씁니다.", en: "Reserved for warning status." },
  },
  {
    id: "color.error",
    group: "color",
